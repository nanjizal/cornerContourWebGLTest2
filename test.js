...
var cornerContour_shape_structs_Rectangle_$ = function(x,y,width,height) {
	this.x = x;
	this.y = y;
	this.width = width;
	this.height = height;
};
cornerContour_shape_structs_Rectangle_$.__name__ = true;
var cornerContourWebGLTest_CornerContourWebGL2 = function() {
	...
	htmlHelper_tools_AnimateTimer.onFrame = function(v) {
		...
		if(_gthis.first) {
			...
			var bounds = new cornerContour_shape_structs_Rectangle_$(minX,minY,maxX - minX,maxY - minY);
			var temp = this1[0];
			var w = bounds.width;
			var sw = 1.5 * w;
			var h = bounds.height;
